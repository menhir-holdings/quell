...
/**
 * OLL 1–57. Primary algs from SolveTheCube (trigger-based: sexy, sledge, R U R' U).
 * Numbering is the speedsolving.com wiki order.
 */
export const OLL: CaseDef[] = [
  ...
  c(34, "OLL 34", "C", "(R U R' U') x D' R' U R U' D x'"),
  ...
  c(42, "OLL 42", "Awkward", "(L F' L' F) L' U2 L d (R U R')"),
  ...
  c(50, "OLL 50", "L", "(R' F R' F') R2 U2 y (R' F R F')"),
  c(51, "OLL 51", "Line", "f (R U R' U') (R U R' U') f'"),
  c(52, "OLL 52", "Line", "(R U R' U) R d' R U' R' F'"),
